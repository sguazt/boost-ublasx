...
/**
 * \file boost/numeric/ublasx/expression/matrix_unary_functor.hpp
 *
 * \brief Matrix expression for applying unary functors to a matrix expression.
 *
...
#ifndef BOOST_NUMERIC_UBLASX_EXPRESSION_MATRIX_UNARY_FUNCTOR_HPP
#define BOOST_NUMERIC_UBLASX_EXPRESSION_MATRIX_UNARY_FUNCTOR_HPP
...
class matrix_unary_functor: public matrix_expression< matrix_unary_functor<ExprT, SignatureT> >
{
    ...
    private: typedef matrix_unary_functor<ExprT, SignatureT> self_type;
    ...
    public: BOOST_UBLAS_INLINE matrix_unary_functor(expression_type const& e, functor_type const& f)
        : e_(e),
        f_(f)
    {
        // Empty
    ...
    // Closure comparison
    public: BOOST_UBLAS_INLINE bool same_closure(matrix_unary_functor const& mu1) const
    {
...
#ifndef BOOST_UBLAS_USE_INDEXED_ITERATOR
    public: class const_iterator1: public container_const_reference<matrix_unary_functor>,
                                   public iterator_base_traits<typename ExprT::const_iterator1::iterator_category>::template iterator_base<const_iterator1, value_type>::type
    {
        ...
        public: typedef typename matrix_unary_functor::difference_type difference_type;
        public: typedef typename matrix_unary_functor::value_type value_type;
        public: typedef typename matrix_unary_functor::const_reference reference;
        public: typedef typename matrix_unary_functor::const_pointer pointer;
    ...
    public: class const_iterator2: public container_const_reference<matrix_unary_functor>,
...
template <typename ExprT, typename SignatureT>
struct matrix_unary_functor_traits
{
    typedef matrix_unary_functor<ExprT, SignatureT> expression_type;
...
#endif // BOOST_NUMERIC_UBLASX_EXPRESSION_MATRIX_UNARY_FUNCTOR_HPP
