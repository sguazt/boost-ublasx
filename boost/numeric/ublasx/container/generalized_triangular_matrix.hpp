...
void matrix_resize_preserve(M& m, M& temporary)
{
	...
	for (size_type major = 0; major < major_size; ++major)
	{
		for (size_type minor = 0; minor < minor_size; ++minor)
		{
			...
			{
				temporary.data()[triangular_type::element(layout_type(), i1, size1, i2, size2)] = m.data()[triangular_type::element(layout_type(), i1, msize1, i2, msize2)];
			}
		}
	}
...
struct kth_upper_tag: public upper_tag {};

template <typename Z>
struct basic_kth_lower: public basic_lower<Z>
{
	typedef Z size_type;
	typedef kth_lower_tag triangular_type;

	template<typename L>
	static
	BOOST_UBLAS_INLINE
	size_type packed_size(L, size_type size_i, size_type size_j, size_type k)
	{
		size_type size = ::std::min(size_i, size_j) - k;
		return L::storage_size(size_i, size_j) - L::triangular_size(size, size);
	}
	...
	size_type element (L, size_type i, size_type size_i, size_type j, size_type size_j) {
		...
		BOOST_UBLAS_CHECK (size_i != 0 && size_j != 0 && i <= k, bad_index());
...
/**
 * \brief Generalized triangular matrix.
 *
 ...
 * - <em>triangular matrices</em>: a square matrix \f$A\f$ of order \f$n\f$ is a
 *   <em>triangular matrix</em> if \f$a_{ij}=0\f$ for \f$i \ne j\f$,
 *   \f$i,j=0,\ldots,n\f$;
 * - <em>rectangular triangular matrices</em>: an \f$m \times n\f$ matrix \f$A\f$
 *   is a <em>rectangular triangular matrix</em> if \f$a_{ij}=0\f$ for
 ...
 * - <em>sub-triangular matrices</em>: a square matrix \f$A\f$ of order
 *   \f$n\f$ is a <em>k-th sub-triangular matrix</em> if \f$a_{ij}=0\f$ for
 *   \f$i \ne (j+k)\f$, \f$i=1,\ldots,n\f$ and \f$j=1,\ldots,n\f$;
 * - <em>super-triangular matrices</em>: a square matrix \f$A\f$ of order \f$n\f$
 *   is a <em>k-th super-triangular matrix</em> if \f$a_{ij}=0\f$ for
 *   \f$(i+k) \ne j\f$, \f$i=1,\ldots,n\f$ and \f$j=1,\ldots,n\f$;
 * - <em>rectangular sub-triangular matrices</em>: a \f$m \times n\f$ matrix
 *   \f$A\f$ is a <em>k-th rectangular sub-triangular matrix</em> if
 *   \f$a_{ij}=0\f$ for \f$i \ne (j+k)\f$, \f$i=1,\ldots,m\f$ and
 *   \f$j=1,\ldots,n\f$;
 * - <em>rectangular super-triangular matrices</em>: a \f$m \times n\f$ matrix
 *   \f$A\f$ is a <em>k-th rectangular super-triangular matrix</em> if
...
>
class generalized_triangular_matrix: public matrix_container<generalized_triangular_matrix<ValueT, TriangularT, LayoutT, ArrayT> >
{

	private: typedef ValueT *pointer;
	private: typedef TriangularT triangular_type;
	private: typedef LayoutT layout_type;
	private: typedef generalized_triangular_matrix<ValueT, TriangularT, LayoutT, ArrayT> self_type;
...
//		  c_(0),
	...
	/**
	 * \brief Create a triangular matrix of order \a size whose non-zero elements
	 *  are on triangular \a k.
	 */
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix(size_type size, difference_type k=0)
		: matrix_container<self_type>(),
		  size1_(size),
		  size2_(size),
		  k_(k),
...
//		  c_(k > 0 ?  k : 0),
	...
	/**
	 * \brief Create a rectangular triangular matrix of size \a size1 by \a size2
	 * whose non-zero elements are on triangular \a k.
	 */
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix(size_type size1, size_type size2, difference_type k)
		: matrix_container<self_type>(),
		  size1_(size1),
		  size2_(size2),
		  k_(k),
...
//		  c_(k > 0 ?  k : 0),
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix(size_type size, difference_type k, array_type const& data)
		: matrix_container<self_type>(),
		  size1_(size),
		  size2_(size),
		  k_(k),
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix(size_type size1, size_type size2, difference_type k, array_type const& data)
		: matrix_container<self_type>(),
		  size1_(size1),
		  size2_(size2),
		  k_(k),
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix(generalized_triangular_matrix const& m)
		: matrix_container<self_type>(),
		  size1_(m.size1_),
		  size2_(m.size2_),
		  k_(m.k_),
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix(matrix_expression<ExprT> const& me, difference_type k=0)
		: matrix_container<self_type>(),
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix(vector_expression<ExprT> const& ve, difference_type k=0)
		: matrix_container<self_type>(),
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix& operator=(generalized_triangular_matrix const& m)
	{
		size1_ = m.size1_;
		size2_ = m.size2_;
		k_ = m.k_;
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_matrix& assign_temporary(generalized_triangular_matrix& m)
	{
		swap(m);
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& operator=(matrix_expression<ExprT> const& me)
	{
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& assign(matrix_expression<ExprT> const& me)
	{
		matrix_assign<scalar_assign>(*this, me);
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& operator=(vector_expression<ExprT> const& ve)
	{
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& assign(vector_expression<ExprT> const& ve)
	{
		return operator=(ve);
	}
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& plus_assign(matrix_expression<ExprT> const& me)
	{
	...
	public: template <typename ExprT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& minus_assign(matrix_expression<ExprT> const& me)
	{
	...
	public: template <typename ScalarT>
		BOOST_UBLAS_INLINE
		generalized_triangular_matrix& operator*=(ScalarT const& se)
	{
	...
	public: BOOST_UBLAS_INLINE
		void swap(generalized_triangular_matrix& m)
	{
		if (this != &m)
		{
	...
	public: BOOST_UBLAS_INLINE
		friend void swap(generalized_triangular_matrix& m1, generalized_triangular_matrix& m2)
	{
		m1.swap(m2);
	}
	...
	public: class const_iterator1: 	public container_const_reference<generalized_triangular_matrix>,
									public random_access_iterator_base<packed_random_access_iterator_tag, const_iterator1, value_type>
	{
		public: typedef typename generalized_triangular_matrix::value_type value_type;
		public: typedef typename generalized_triangular_matrix::difference_type difference_type;
		public: typedef typename generalized_triangular_matrix::const_reference reference;
		public: typedef const typename generalized_triangular_matrix::pointer pointer;
	...
	public: class iterator1: 	public container_reference<generalized_triangular_matrix>,
								public random_access_iterator_base<packed_random_access_iterator_tag, iterator1, value_type>
	{
		public: typedef typename generalized_triangular_matrix::value_type value_type;
		public: typedef typename generalized_triangular_matrix::difference_type difference_type;
		public: typedef typename generalized_triangular_matrix::reference reference;
		public: typedef typename generalized_triangular_matrix::pointer pointer;
	...
	public: class const_iterator2: 	public container_const_reference<generalized_triangular_matrix>,
	...
	public: class iterator2: 	public container_reference<generalized_triangular_matrix>,
	...
	/**
	 * \brief The triangular offset: \c 0 for the main triangular,
	 *  <code>&gt; 0</code> for super-triangulars,
	 *  and <code>&lt; 0</code> for sub-triangulars.
	 */
	private: difference_type k_;
	/// The starting row of the triangular.
	private: size_type r_;
	/// The starting column of the triangular.
	private: size_type c_;
	/// The data array.
	private: array_type data_;
	/// The zero value used as return value for elements off the triangular.
...
template<
	...
	typename ArrayT
>
typename generalized_triangular_matrix<ValueT,LayoutT,ArrayT>::const_value_type generalized_triangular_matrix<ValueT,LayoutT,ArrayT>::zero_ = generalized_triangular_matrix<ValueT,LayoutT,ArrayT>::value_type/*zero*/();


/**
 * \brief Generalized triangular matrix adaptor: convert any matrix into a
 *  generalized triangular matrix.
 *
 * \author Marco Guazzone, marco.guazzone@gmail.com
 */
template <typename MatrixT>
class generalized_triangular_adaptor: public matrix_expression< generalized_triangular_adaptor<MatrixT> >
{
	private: typedef generalized_triangular_adaptor<MatrixT> self_type;
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_adaptor(matrix_type& data, difference_type k = 0)
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_adaptor(generalized_triangular_adaptor const& m)
		: matrix_expression<self_type>(),
		  data_(m.data_),
		  k_ (m.k_),
		  r_(m.r_),
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& operator=(generalized_triangular_adaptor const& m)
	{
		//[FIXME]
		// These instructions are to allow assignment of matrices with
		// different structure (i.e., different triangular offset).
	...
	public: BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& assign_temporary(generalized_triangular_adaptor& m)
	{
		*this = m;
		return *this;
	}
	...
	public: template<class AE>
		BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& operator=(matrix_expression<AE> const& ae)
	{
	...
	public: template<class AE>
		BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& assign(matrix_expression<AE> const& ae)
	{
	...
	public: template<class AE>
		BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& plus_assign(matrix_expression<AE> const& ae)
	{
	...
	public: template<class AE>
		BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& minus_assign(matrix_expression<AE> const& ae)
	{
	...
	public: template<class AT>
		BOOST_UBLAS_INLINE
		generalized_triangular_adaptor& operator*=(AT const &at)
	{
	...
	// Closure comparison
	public: BOOST_UBLAS_INLINE
		bool same_closure(generalized_triangular_adaptor const& ba) const
	{
	...
	public: BOOST_UBLAS_INLINE
		void swap(generalized_triangular_adaptor& m)
	{
		if (this != &m)
		{
	...
	public: BOOST_UBLAS_INLINE
		friend void swap(generalized_triangular_adaptor& m1, generalized_triangular_adaptor& m2)
	{
		m1.swap(m2);
	}
...
//		}
	...
	public: class const_iterator1: public container_const_reference<generalized_triangular_adaptor>,
	...
	public: class iterator1: public container_reference<generalized_triangular_adaptor>,
							 public random_access_iterator_base<
										typename iterator_restrict_traits<
	...
	public: class const_iterator2: public container_const_reference<generalized_triangular_adaptor>,
								   public random_access_iterator_base<
										packed_random_access_iterator_tag,
										const_iterator2,
										value_type
	...
	public: class iterator2: public container_reference<generalized_triangular_adaptor>,
							 public random_access_iterator_base<
										typename iterator_restrict_traits<
...
template <typename MatrixT>
typename generalized_triangular_adaptor<MatrixT>::const_value_type generalized_triangular_adaptor<MatrixT>::zero_ = generalized_triangular_adaptor<MatrixT>::value_type/*zero*/();
...
template <typename MatrixT>
struct vector_temporary_traits< ::boost::numeric::ublasx::generalized_triangular_adaptor<MatrixT> >: vector_temporary_traits<MatrixT> {};


template <typename MatrixT>
struct vector_temporary_traits< const ::boost::numeric::ublasx::generalized_triangular_adaptor<MatrixT> >: vector_temporary_traits<MatrixT> {};


template <typename MatrixT>
struct matrix_temporary_traits< ::boost::numeric::ublasx::generalized_triangular_adaptor<MatrixT> >: matrix_temporary_traits<MatrixT> {};


template <typename MatrixT>
struct matrix_temporary_traits< const ::boost::numeric::ublasx::generalized_triangular_adaptor<MatrixT> >: matrix_temporary_traits<MatrixT> {};
