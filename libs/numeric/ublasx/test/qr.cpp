...
/**
 * \file libs/numeric/ublasx/test/qr.cpp
 *
 * \brief Test suite for the QR factorization.
 *
...
BOOST_UBLASX_TEST_DEF( test_real_square_matrix_row_major )
{
    ...
    ublasx::qr_decompose(A, Q, R);

    BOOST_UBLASX_DEBUG_TRACE( "A = " << A );
    BOOST_UBLASX_DEBUG_TRACE( "Q = " << Q );
    BOOST_UBLASX_DEBUG_TRACE( "R = " << R );
    BOOST_UBLASX_DEBUG_TRACE( "Q*R = " << ublas::prod(Q, R) );

    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(Q) == n );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(Q) == n );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(R) == n );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(R) == n );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( ublas::prod(Q, R), A, n, n, tol );
}
...
BOOST_UBLASX_TEST_DEF( test_real_recth_matrix_row_major_full )
{
    ...
    ublasx::qr_decompose(A, Q, R, true);
    ...
    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(R) == m );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(R) == n );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( ublas::prod(Q, R), A, m, n, tol );
}
...
BOOST_UBLASX_TEST_DEF( test_real_recth_matrix_row_major_econ )
{
    ...
    ublasx::qr_decompose(A, Q, R, false);
...
{
    BOOST_UBLASX_DEBUG_TRACE("Test Case: Real - Square Matrix - Row Major -- QR Decomposition object");
    ...
    ublasx::qr_decomposition<value_type> qr(A);

    BOOST_UBLASX_DEBUG_TRACE( "A = " << A );
    BOOST_UBLASX_DEBUG_TRACE( "Q = " << qr.Q() );
    BOOST_UBLASX_DEBUG_TRACE( "R = " << qr.R() );
    BOOST_UBLASX_DEBUG_TRACE( "Q*R = " << ublas::prod(qr.Q(), qr.R()) );

    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(qr.Q()) == n );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(qr.Q()) == n );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(qr.R()) == n );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(qr.R()) == n );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( ublas::prod(qr.Q(), qr.R()), A, n, n, tol );
}


BOOST_UBLASX_TEST_DEF( test_real_square_matrix_column_major_oo )
{
    BOOST_UBLASX_DEBUG_TRACE("Test Case: Real - Square Matrix - Column Major -- QR Decomposition object");
...
{
    BOOST_UBLASX_DEBUG_TRACE("Test Case: Complex - Square Matrix - Row Major -- QR Decomposition object");
...
{
    BOOST_UBLASX_DEBUG_TRACE("Test Case: Complex - Square Matrix - Column Major -- QR Decomposition object");
...
BOOST_UBLASX_TEST_DEF( test_real_matrix_prod_left_notrans_column_major )
{
    ...
    BOOST_UBLASX_DEBUG_TRACE( "Q*C = " << ublas::prod(qr.Q(true), C) );

    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(X) == A_nr );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(X) == C_nc );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( X, ublas::prod(qr.Q(true), C), A_nr, C_nc, tol );
}
...
BOOST_UBLASX_TEST_DEF( test_real_matrix_prod_left_trans_column_major )
{
    ...
    BOOST_UBLASX_DEBUG_TRACE( "C = " << A );
    BOOST_UBLASX_DEBUG_TRACE( "X = " << X );
    BOOST_UBLASX_DEBUG_TRACE( "Q'*C = " << ublas::prod(ublas::trans(qr.Q(true)), C) );

    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(X) == A_nr );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(X) == C_nc );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( X, ublas::prod(ublas::trans(qr.Q(true)), C), A_nr, C_nc, tol );
}
...
BOOST_UBLASX_TEST_DEF( test_real_matrix_prod_right_notrans_column_major )
{
    ...
    BOOST_UBLASX_DEBUG_TRACE( "X = " << X );
    BOOST_UBLASX_DEBUG_TRACE( "C*Q = " << ublas::prod(C, qr.Q(true)) );

    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(X) == C_nr );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(X) == C_nc );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( X, ublas::prod(C, qr.Q(true)), C_nr, C_nc, tol );
}
...
BOOST_UBLASX_TEST_DEF( test_real_matrix_prod_right_trans_column_major )
{
    ...
    BOOST_UBLASX_DEBUG_TRACE( "C = " << C );
    BOOST_UBLASX_DEBUG_TRACE( "X = " << X );
    BOOST_UBLASX_DEBUG_TRACE( "C*Q' = " << ublas::prod(C, ublas::trans(qr.Q(true))) );

    BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(X) == C_nr );
    BOOST_UBLASX_TEST_CHECK( ublasx::num_columns(X) == C_nc );
    BOOST_UBLASX_TEST_CHECK_MATRIX_CLOSE( X, ublas::prod(C, ublas::trans(qr.Q(true))), C_nr, C_nc, tol );
}


int main()
{
    BOOST_UBLASX_DEBUG_TRACE("Test Suite: QR factorization");
