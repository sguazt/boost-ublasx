...
/**
 * \file libs/numeric/ublasx/find.cpp
 *
 * \brief Test suite for the \c find operation.
 *
...
BOOST_UBLASX_TEST_DEF( test_vector_container )
{
    ...
    res = ublasx::find(z);
    BOOST_UBLASX_DEBUG_TRACE( "find(" << z << ") = " << res << " ==> " << expect );
    ...
    expect(1) = 1.023787;
    res = ublasx::find(v);
    BOOST_UBLASX_DEBUG_TRACE( "find(" << v << ") = " << res << " ==> " << expect );
    ...
    expect(0) = 1.023787;
    res = ublasx::find(v, ::std::bind2nd(::std::greater<value_type>(), val));
    BOOST_UBLASX_DEBUG_TRACE( "find(" << v << ", > " << val << ") = " << res << " ==> " << expect );
...
BOOST_UBLASX_TEST_DEF( test_vector_reference )
{
    ...
    expect(0) = 0.108929;
    expect(1) = 1.023787;
    res = ublasx::find(vector_reference_type(v));
    BOOST_UBLASX_DEBUG_TRACE( "find(" << vector_reference_type(v) << ") = " << res << " ==> " << expect );
    BOOST_UBLASX_TEST_CHECK_VECTOR_EQ( res, expect, 2 );
    ...
    expect = out_vector_type(1);
    expect(0) = 1.023787;
    res = ublasx::find(vector_reference_type(v), ::std::bind2nd(::std::greater<value_type>(), val));
    BOOST_UBLASX_DEBUG_TRACE( "find(" << vector_reference_type(v) << ", > " << val << ") = " << res << " ==> " << expect );
    BOOST_UBLASX_TEST_CHECK_VECTOR_EQ( res, expect, 1 );
...
int main()
{
    BOOST_UBLASX_DEBUG_TRACE("Test Suite: 'find' operations");
