/**
 * \file libs/numeric/ublasx/test/element_pow.cpp
 *
 * \brief Test suite for the \c element_pow operation.
 *
...
BOOST_UBLASX_TEST_DEF( test_real_vector_1 )
{
	...
	res = ublasx::element_pow(v, exp);

	BOOST_UBLASX_DEBUG_TRACE( "v = " << v );
	BOOST_UBLASX_DEBUG_TRACE( "element_pow(v," << exp << ") = " << res );
...
BOOST_UBLASX_TEST_DEF( test_real_vector_2 )
{
	...
	res = ublasx::element_pow(base, v);

	BOOST_UBLASX_DEBUG_TRACE( "v = " << v );
	BOOST_UBLASX_DEBUG_TRACE( "element_pow(" << base << ",v) = " << res );
...
BOOST_UBLASX_TEST_DEF( test_real_matrix_1 )
{
	...
	R = ublasx::element_pow(A, exp);

	BOOST_UBLASX_DEBUG_TRACE( "A = " << A );
	BOOST_UBLASX_DEBUG_TRACE( "element_pow(A, " << exp << ") = " << R );
...
BOOST_UBLASX_TEST_DEF( test_real_matrix_2 )
{
	...
	R = ublasx::element_pow(base, A);

	BOOST_UBLASX_DEBUG_TRACE( "A = " << A );
	BOOST_UBLASX_DEBUG_TRACE( "element_pow(" << base << ",A) = " << R );
...
int main()
{
	...
	BOOST_UBLASX_DEBUG_TRACE("Test Suite: 'element_pow' operation");
