...
/**
 * \file libs/numeric/ublasx/test/realmax.cpp.
 *
...
#include <boost/numeric/ublasx/operation/realmax.hpp>
#include <cmath>
...
BOOST_UBLASX_TEST_DEF( single_precision )
{
    ...
    value_type res = ublasx::realmax<value_type>();
    value_type expect_res = ::std::numeric_limits<value_type>::max();
...
int main()
{
    BOOST_UBLASX_DEBUG_TRACE("Test Suite: 'realmax' operations");
