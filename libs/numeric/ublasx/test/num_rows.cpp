/**
 * \file libs/numeric/ublasx/num_rows.hpp
 *
 * \brief Test suite for the \c num_rows operation.
 *
...
BOOST_UBLASX_TEST_DEF( test_row_major_matrix_container )
{
	...
	BOOST_UBLASX_DEBUG_TRACE( "num_rows(A) = " << ublasx::num_rows(A) << " ==> " << A.size1() );
	BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(A) == A.size1() );
}
...
BOOST_UBLASX_TEST_DEF( test_matrix_expression )
{
	...
	BOOST_UBLASX_DEBUG_TRACE( "num_rows(A') = " << ublasx::num_rows(ublas::trans(A)) << " ==> " << ublas::trans(A).size1() );
	BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(ublas::trans(A)) == ublas::trans(A).size1() );
}
...
BOOST_UBLASX_TEST_DEF( test_matrix_reference )
{
	...
	BOOST_UBLASX_DEBUG_TRACE( "num_rows(reference(A)) = " << ublasx::num_rows(matrix_reference_type(A)) << " ==> " << matrix_reference_type(A).size1() );
	BOOST_UBLASX_TEST_CHECK( ublasx::num_rows(matrix_reference_type(A)) == matrix_reference_type(A).size1() );
}


int main()
{
	BOOST_UBLASX_DEBUG_TRACE("Test Suite: 'num_rows' operation");
