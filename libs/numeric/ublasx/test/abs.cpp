...
/**
 * \file libs/numeric/ublasx/test/abs.cpp
 *
 * \brief Test suite for the \c abs operation.
 *
...
int main()
{
    ...
    BOOST_UBLASX_DEBUG_TRACE("Test Suite: 'abs' operation");
